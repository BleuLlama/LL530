...
/*
   Modified 5/13/2020 Scott Lawrence yorgle@gmail.com
   - rewired per LL530 pinouts
*/
...
// Pin Assignment
#undef PINOUT_LL530_A
#define PINOUT_LL530_B
#undef PINOUT_ORIGINAL


// LL530 Controller Port A - AOK!
#ifdef PINOUT_LL530_A
const int UPin = 5;     // D9-1
const int DOWNin = 4;   // D9-2
const int LEFTin = 3;   // D9-3
const int RIGHTin = 2;  // D9-4
const int FIREin = 7;   // D9-6 Fire1 or Clock out @ CD32
const int DATAin = 8;   // D9-9 Fire2 or Data in @ CD32
const int MODEout = 6;  // D9-5 Joystick or Gamepad Mode selected
#endif

// LL530 Controller Port B - AOK!
#ifdef PINOUT_LL530_B
const int UPin = 16;     // D9-1
const int DOWNin = 15;   // D9-2
const int LEFTin = 18;   // D9-3
const int RIGHTin = 19;  // D9-4
const int FIREin = 14;   // D9-6 Fire1 or Clock out @ CD32
const int DATAin = 20;   // D9-9 Fire2 or Data in @ CD32
const int MODEout = 21;  // D9-5 Joystick or Gamepad Mode selected
#endif

#ifdef PINOUT_ORIGINAL
