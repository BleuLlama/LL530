...
// following are my additions for this project
// -SDL 2018
#ifndef __HID_MODIFIERS__
#define __HID_MODIFIERS__

#define KEYM_NONE       (0x00)
#define KEYM_LEFTCTRL   (0x01)
#define KEYM_RIGHTCTRL  (0x10)
#define KEYM_LEFTSHIFT  (0x02)
#define KEYM_RIGHTSHIFT (0x20)
#define KEYM_LEFTALT    (0x04)
#define KEYM_RIGHTALT   (0x40)
#define KEYM_LEFTMETA   (0x08)
#define KEYM_RIGHTMETA  (0x80)
